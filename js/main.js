...
const CONFIG = {
    API_URL: '/api',
    AMAZON_AFFILIATE_ID: 'TUO-AFFILIATE-ID-21', // Inserisci il tuo Amazon Associates ID
    TELEGRAM_URL: 'https://t.me/tuocanale' // Inserisci il link al tuo canale Telegram
};
